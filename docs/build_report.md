...
*   **TinyDB:** A lightweight, document-oriented NoSQL database that stores data in a simple JSON file. Ideal for this scale as it requires no separate database server.
